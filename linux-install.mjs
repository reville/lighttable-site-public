import { manifestReleases, releaseManifest } from "./release-downloads.mjs?release=5814b62fc3b1949d";
import { detectArchitecture, selectDownload } from './downloads.mjs?release=5814b62fc3b1949d';
