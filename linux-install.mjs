import { manifestReleases, releaseManifest } from "./release-downloads.mjs?release=1da2e5ed6c3fb4bb";
import { detectArchitecture, selectDownload } from './downloads.mjs?release=1da2e5ed6c3fb4bb';
