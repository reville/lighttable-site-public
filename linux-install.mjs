import { manifestReleases, releaseManifest } from "./release-downloads.mjs?release=b1b5ae57f659d057";
import { detectArchitecture, selectDownload } from './downloads.mjs?release=b1b5ae57f659d057';
