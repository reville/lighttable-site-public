import { manifestReleases, releaseManifest } from "./release-downloads.mjs?release=566e421992eedc4d";
import { detectArchitecture, selectDownload } from './downloads.mjs?release=566e421992eedc4d';
